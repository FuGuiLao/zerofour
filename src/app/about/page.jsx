    ...
    people: [
      {
        ...
        blurb:
          "Jayden has served in federal and local law enforcement and intelligence roles throughout his career. He previously worked as a Deputy Sheriff with the Los Angeles County Sheriff’s Department, with assignments in field operations, custody, training, and special units. His experience includes criminal investigations, interrogations, undercover surveillance, case management, evidence handling, and the application of California and federal law. Jayden attained California POST Certification, completed Advanced Officer Training, and fulfilled the coursework for POST Specialized Investigator Certification. He has worked alongside agencies including LASD, LAPD, the U.S. Marshals Service, Diplomatic Security Service, U.S. Secret Service, FBI, Department of Homeland Security, ICE, and the Superior Court of California. In addition to government service, he has held leadership roles in the financial services industry, overseeing regulated operations, corporate due diligence, and fraud investigations. He has also provided regulatory compliance, security, and legal consulting for individuals and companies across multiple industries. Jayden studied computer engineering at Claremont McKenna College.",
      },
      {

        ...
        <div className="mb-20 mt-24 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
          ...
          <p className="text-sm text-neutral-700">
            © {new Date().getFullYear()} Zerofour Inc. All Rights Reserved.<br />
             <a href="/pdf/terms-of-use.pdf" target="_blank" rel="noopener noreferrer">Terms of Use</a> | <a href="@/privacy-policy.pdf" target="_blank" rel="noopener noreferrer">Privacy Policy</a> | <a href="/data-security.pdf" target="_blank" rel="noopener noreferrer">Data Security</a>
          </p>
        </div>
      </FadeIn>
    </Container>
